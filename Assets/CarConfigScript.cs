...
public class CarConfigScript : MonoBehaviour
{
   ...
   // public Slider MaxCameraFOVSlider;
    ...
    void Start()
    {
        ...
        MaxCameraAngleText.text = CameraAngle.ToString("0.##");
    }
    ...
    {
        MaxCameraAngleText.text = value.ToString("0.##");
        CameraAngle = value;
        
        CameraSensor cameraSensor = GameObject.FindObjectOfType<CameraSensor>();
        if (cameraSensor != null)
        {
            cameraSensor.transform.localEulerAngles = new Vector3(value, 0, 0);
        }
    }
